...
const ThirdSection = async (props: Props) => {
  ...
  if (completedProjects.length === 0 && ongoingProjects.length === 0) {
    return null;
  }
    ...
    <div className="py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      {ongoingProjects.length > 0 && (
        <div className="mb-16 md:mb-24">
          <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-5 md:space-y-6 pb-8 md:pb-12">
            ...
            <p className="text-center text-neutral-500 text-sm sm:text-base md:text-lg font-light uppercase px-4">
              Creating new landmarks for modern living
            </p>
          </div>
